...
namespace Pvtl\VoyagerSliders\Providers;

use Pvtl\VoyagerSliders\Commands;
use Illuminate\Support\ServiceProvider;

class VoyagerSlidersServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        // Load views
        $this->loadViewsFrom(self::PACKAGE_DIR . 'resources/views', 'voyager-sliders');
